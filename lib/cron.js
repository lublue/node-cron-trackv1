(function(root, factory) {
	...
	CronTime.prototype = {
		 ...
		 */
		getTimeout: function() {
			let localTimeToMillis = moment();
			let sendAtToMillis = this.sendAt();
			return Math.max(-1, sendAtToMillis - localTimeToMillis);
		},
	...
	var start = function() {
      ...
      console.log(`CRON STOP DEBUG -> STOP with timeout: ${timeout}`);
			this.stop();
		}
	};
